...
export function LightingRig({ mode }: { mode: GreyboxMode }) {
  ...
  return (
    <>
      ...
      />
      <pointLight color={workshop ? "#d36a3c" : "#7a63cb"} intensity={workshop ? 5.5 : 8} position={[-4, 3.5, -3]} distance={13} />
      <pointLight color={workshop ? "#8d5bbd" : "#bc7bd7"} intensity={4.2} position={[4.5, 2.4, -2.5]} distance={10} />
    </>
  );
}
